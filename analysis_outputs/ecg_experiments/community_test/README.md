...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Notebook 2 four-channel | 0.4982 | 1.000 | 0.965 | 0.556 | 0.714 | 0.983 | 0.967 | 0.998 | 5 | 0 | 111 | 4 |
| Best separate-site | 0.1212 | 1.000 | 0.878 | 0.263 | 0.417 | 0.939 | 0.900 | 0.991 | 5 | 0 | 101 | 14 |

Both models found all five HFrEF patients. The separate-site model produced ten more false warnings. The notebook 2 four-channel model performed better on this test set.
...
- `community_test_results.csv`: all reported measures for both cutoff rules, plus notebook 2's saved cutoff.
